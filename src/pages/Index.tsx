...
const Index = () => {
  ...
  return (
    <Layout>
      <SEO title="Audit de Maturité IA – Accueil" description="Auto‑évaluez la maturité IA de votre entreprise par département et générez un plan d’action priorisé." canonical={window.location.origin + "/"} />
