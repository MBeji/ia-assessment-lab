...
const Archives = () => {
  ...
  return (
    <Layout>
      <SEO title="SynapFlow – Archives" description="Historique des évaluations (missions)." canonical={window.location.origin + "/archives"} />
      <div className="mb-6 space-y-4">
        <h1 className="text-2xl font-semibold">Missions / Archives</h1>
        <p className="text-sm text-muted-foreground">Toutes les évaluations enregistrées par statut.</p>
